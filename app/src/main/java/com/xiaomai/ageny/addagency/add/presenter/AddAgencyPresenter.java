...
public class AddAgencyPresenter extends BasePresenter<AddAgencyContract.View> implements AddAgencyContract.Presenter {
    ...
    public void getData(RequestBody body) {
        ...
        mView.showLoading();
        model.getData(body).compose(RxScheduler.<AddAgencyBean>Flo_io_main())
                .subscribe(new Consumer<AddAgencyBean>() {
                    @Override
                    public void accept(AddAgencyBean bean) throws Exception {
